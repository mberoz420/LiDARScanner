...
updateManifest($filename, $numPoints);

respond(200, null, ['success' => true, 'filename' => $filename, 'num_points' => $numPoints]);

// ── Helpers ───────────────────────────────────────────────────────────────────

function updateManifest(string $filename, int $numPoints): void {
