...
// If a project is specified, save under scans/{project}/photos/SESSION_ID
if (!empty($project)) {
    $project = basename($project);  // prevent directory traversal
    $photosBase = SCANS_PATH . '/' . $project . '/photos';
} else {
